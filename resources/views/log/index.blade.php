            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Log Activity Fasilitas A2B Airport Equipment</h1>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6 col-md-5 mb-4">
                            <a class="nav-link" href="/dashboard/log-hanggar/"><div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                        ...
                        <!-- HBS Card -->
                        <div class="col-xl-6 col-md-5 mb-4">
                            <a class="nav-link" href="log-hbs.html"><div class="card border-left-warning shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
