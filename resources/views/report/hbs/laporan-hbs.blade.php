...
<head>
    ...
    <title>Laporan Inspeksi HBS / X-Ray</title>

    <!-- Custom fonts for this template-->
    <link href="{{ URL::asset ('style/vendor/fontawesome-free/css/all.min.css') }}" rel="stylesheet">
    <link
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h3 class="h3 mb-0 text-gray-800">Laporan Inspeksi 4</h3>
                    </div>

                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Tabel Fasilitas HBS / X-Ray</h6>
                        </div>
                        <div class="card-body">
